...
//!
//! ![An image of a pumpkin pile](https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/FrenchMarketPumpkinsB.jpg/700px-FrenchMarketPumpkinsB.jpg)
...
// Use `cargo doc --release --document-private-items --no-deps`
enum PrivateEnum {
